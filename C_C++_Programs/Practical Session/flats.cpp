...
int main()
{
	...
	printf("Case 1: Creat flat.\nCase 2: Allocate flat to owner.\nCase 3: Check flat available or not.\nCase 4: Allocate parking for society.\nCase 5: Allocate partaking to flat owner.\nCase 6: Check open parking.\nCase 7: Search owner by flat no.\nCase 8: Search owner by name.\nCase 9: View all owner.\nCase 10: Delete Owner by flat number.\n");
